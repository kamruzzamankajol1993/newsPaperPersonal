...
@endif
    ...
    <div id="center-header">
        <div class="container">
            <div class="header-logo content-news-logo">
                ...
                <center><div style="">
                    <a href="{{ route('home') }}" class="logo"><img src="{{asset('/')}}{{ $logo }}"
                                                                    alt=""></a>
    ...
    <div id="" class="nav-header1">

            <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12" style="background-color:#CCCCCC;">

                    <div class="" style="margin-left: -15px;background-color:#CCCCCC;float:left;width: 101px; ">
...
Latest:
                    ...
                    <div class="" style="overflow: hidden;margin-top:23px;background-color:#CCCCCC">
...
<div id="nav-header" class="mdis1">
    ...
    font-size: 25px;"></i></button>
                  ...
                  <div class="nav-logo">
                        <a href="{{ route('home') }}" class="logo"><img src="{{asset('/')}}{{ $logo }}" alt="" > </a>
                    </div>
...
@endforeach
            ...
            <div class="button-nav">
                ...
                <a href="{{ route('home') }}" class="logo logo-betwn-icon ml-3" style="display:inline-block;"><img class="img-fluid image-betwen-icon mr-auto" src="{{asset('/')}}public/front/img/logo-ol3t6tqtnvngxth3oqe5r1rnder00ua1dt7qcy4lj6_182x70.png"
                                                                    alt=""></a>
    ...
    <!--mobile-->
    <div id="nav-header" class="nav-header1">
        <div class="container">
            <nav id="main-nav">
                <div class="nav-logo">
                    <a href="{{ route('home') }}" class="logo"><img src="{{asset('/')}}{{ $logo }}"
