				...
				<div class="container">
					<div class="row">
							...
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								<ul class="top_bar_contact_list">
									...
									<li class="ml-5">
										...
										<div>environmenttalkbd@gmail.com</div>
									</li>
								</ul>
						...
						<div class="col" style="float:right;text-align: right;">
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								<ul class="top_bar_contact_list" style="margin-left:400px; ">
									
									
									<li class="p-0" >
								<a href="https://www.facebook.com/environmenttalkbd">
								    <i class="fa fa-facebook-square" aria-hidden="true" style="font-size:25px;"></i>
								    </a>
										
									</li>
									<li class="p-0" >
									<a href="https://www.instagram.com/environment_talk_bd/"><i class="fa fa-instagram" aria-hidden="true" style="font-size:25px;"></i></a>	
							...
							<div class="offset-md-5 col-lg-3 footer_col">
								...
								<div class="footer_section footer_contact">
									...
									<div class="footer_contact_info">
										<ul>
											<li>Email: environmenttalkbd@gmail.com</li>
...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v6.0&appId=2457050944625221&autoLogAppEvents=1"></script>
