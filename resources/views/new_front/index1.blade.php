    ...
    <div class="panel-body">
           <div class="row">
               ...
               <div class="col-md-7">
                ...
                <p class="" ><a href="{{route('singlePost',['id'=>$national->id])}}" style="font-size: 14px;">{{ substr(strip_tags($national->title), 0,160)}}</a></p>
               </div>
           </div>
      </div>
     </div>
...
<div class="container">
    <div class="row" style="margin-top:10px;">
            ...
            <div class="col-md-12">
                        ...
                        <a target="_blank" href="https://dailybanglatimes.com"><h2 class="title">English </h2></a>
                            </div>
                        </div>
                        
                        
    <div class="col-sm-12 col-md-12">
        <a href="https://dailybanglatimes.com" target="_blank"><img src="{{asset('/')}}{{$english_lan_banner}}" class="img-fluid" id="lan_image" alt="Responsive image"></a>
    </div>
    </div>
    <div class="row" style="margin-top:10px;">
        @foreach($englishAll as $all_banglaAll)
        <div class="col-sm-3 col-md-3">
            <div class="card">
                <center>
    <img class="card-img-top" src="{{asset('/')}}{{$all_banglaAll->cover_image}}" style="height:100px;" alt="Card image cap">
    </center>
    <div class="card-body">
      <h5 class="card-title"><a target ="_blank"  href="https://dailybanglatimes.com/single/post/{{$all_banglaAll->id}}" style="font-size:15px;font-weight: 500;"><b>{{ $all_banglaAll->title }}</b></a></h5>
...
জাতীয়
                            ...
                            <article class="article" >
                                ...
                                <div class="article-body">
                                    <p class="" style="font-size:13px;padding-left:5px;color:#FE0203;"> {!!  substr(strip_tags($national->op_title), 0, 20) !!}</p>
                <p class="" style="padding-left: 10px;"><a href="{{route('singlePost',['id'=>$national->id])}}" style="font-size:15px;font-weight:700">{{ $national->title}}</a></p>
...
<p class=""><a href="{{route('singlePost',['id'=>$national->id])}}" style="font-size: 15px;color:white;">{{ $national->title }}</a></p>
                    ...
                    <!-- /row -->
                        ...
                        <div class="col-md-3" >
                            <div class="" style="position:relative;width:260px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            ...
                            <article class="article" style="background-color:#EFF3F4;border-bottom: 1px solid #B30F0F;">
                                ...
                                <div class="article-body">
                                    <p class="" style="font-size:13px;padding-left:5px;color:#FE0203;"> {!!  substr(strip_tags($national->op_title), 0, 20) !!}</p>
                <p class="" style="padding-left: 10px;"><a href="{{route('singlePost',['id'=>$national->id])}}" style="font-size:14px;font-weight:700">{{ $national->title}}</a></p>
                ...
                <a href="{{route('post',['id'=>22])}}">
                    <h2 class="title">শেয়ারবাজার</h2>
                            ...
                            <article class="article" >
                                ...
                                <div class="article-body">
                                    <p class="" style="font-size:13px;padding-left:5px;color:#FE0203;"> {!!  substr(strip_tags($national->op_title), 0, 20) !!}</p>
                    <p class="" style="padding-left: 10px;"><a href="{{route('singlePost',['id'=>$national->id])}}" style="font-size:13px;font-weight:700">{{ $national->title}}</a></p>
                ...
                <p style="font-size: 14px;"><a href="{{route('singlePost',['id'=>$national->id])}}">{{ $national->title}}</a></p>
                        ...
                        <div class="col-md-3 col-sm-3" >
                            ...
                            <article class="article">
                                ...
                                <div class="article-body">
                                    <p class="" style="font-size:13px;padding-left:5px;color:#FE0203;">{!!  substr(strip_tags($national->op_title), 0, 20) !!}</p>
                            <p class="" style="padding-left: 10px;"><a href="{{route('singlePost',['id'=>$national->id])}}" style="font-size:12px;font-weight:700">{{ $national->title}}</a></p>
