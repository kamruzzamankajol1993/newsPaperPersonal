...
<div class="section" id="team" style="background-color:#EFF3F4;margin-top: 10px;padding-top: 15px">
     ...
     <div class="container">
        <h5 class="section-title h1">Publisher And Editor-in-Chief</h5>
        <div class="row">
            <!-- Team member -->
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center mt-3" >
                                    ...
                                    <a href="https://zahidfsardersaddi.com" target="_blank"><img class="" style="margin-top:20px;height:60px;" src="https://bangla.dailybanglatimes.com/public/uploads/1679334634.png" alt="card image"></a>
