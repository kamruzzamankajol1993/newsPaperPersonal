                    ...
                    <li>
                      <button class="btn btn-success btn-sm" target="_blank"  id="ggg"  onclick="window.location.href='https://dailybanglatimes.com'" >English</button>
                               ...
                               @if($all_ss_link_list->linkn == 'Facebook')
                                                   ...
                                                   <li><a href="{{$all_ss_link_list->name}}"><img src="https://img.icons8.com/color/48/000000/facebook-circled.png" style="height: 20px;width:20px;"/></a></li>

                               @elseif($all_ss_link_list->linkn == 'Twitter')
                                <li><a href="{{$all_ss_link_list->name}}"><img src="https://img.icons8.com/color/48/000000/twitter-circled.png" style="height: 20px;width:20px;"/></a></li>
                                    @elseif($all_ss_link_list->linkn == 'Instagram')
                                   <li><a href="{{$all_ss_link_list->name}}"><img src="https://img.icons8.com/color/48/000000/instagram" style="height: 20px;width:20px;"/></a></li>
                                    @elseif($all_ss_link_list->linkn == 'Linkedin')
                                   <li><a href="{{$all_ss_link_list->name}}"><img src="https://img.icons8.com/color/48/000000/linkedin" style="height: 20px;width:20px;"/></a></li>
                               @else
                                <li><a href="{{$all_ss_link_list->name}}"><img src="https://img.icons8.com/color/48/000000/youtube-play.png" style="height: 20px;width:20px;"/></a></li>
    ...
    <div id="center-header">
        <div class="container">
            <div class="header-logo content-news-logo">
                ...
                <center><div style="">
                    <a href="{{ route('home1') }}" class="logo"><img src="{{ asset('/') }}{{ $bb_site_logo_header }}"
                                                                    alt=""></a>
   ...
   <div id="" class="nav-header1" style="margin-bottom: 10px;">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12" style="background-color:green;">
                    ...
                    <h6 style="font-size:20px;padding-left: 13px;padding-top:18px;">সর্বশেষ:
</h6>
                    </div>
...
<div id="nav-header" class="mdis1">
    ...
    font-size: 25px;"></i></button>
                  ...
                  <div class="nav-logo">
                        <a href="{{ route('home1') }}" class="logo"><img src="{{ asset('/') }}{{ $bb_site_logo_header }}" alt="" > </a>
                    </div>
...
@else
   ...
   @else
            ...
            <div class="button-nav">
                ...
                <a href="{{ route('home1') }}" class="logo logo-betwn-icon ml-3" style="display:inline-block;"><img class="img-fluid image-betwen-icon mr-auto" src="{{ asset('/') }}{{ $bb_site_logo_header }}"
                                                                    alt=""></a>
...
<li class="dropdown">
            ...
            Other
                    ...
                    <ul class="dropdown-menu p-0" id="dropdown-background" style="">
                        ...
                        <li >
    <a class="dropdown-item" id="new_h" href="{{route('post',['id'=>$subcat->id])}}" >
