...
<div class="row mt-2">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form method="post" action="{{route('admin.news.store1')}}" enctype="multipart/form-data">
                    @csrf
                    <?php
  $dt = new DateTime();
  ...
  <!--  </div>-->
    ...
    <div class="form-group col-md-12 mt-2">
        ...
        <input type="text" class="form-control" name="total_view" value="ডেইলি বাংলা টাইমস" placeholder="Source Name" required>
      </div>
     ...
     <div class="form-group col-md-12 mt-2">
          ...
          <input type="submit" class="btn btn-info col-12 mt-2" name="dvalue" value="draft">
        </div>
