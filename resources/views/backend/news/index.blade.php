...
$dd = $baseUrl.'https://bangla.dailybanglatimes.com/single/post/4786';
?>

                <a href="{{ route('admin.news.create') }}" target="_blank" class="btn btn-success dropdown-toggle waves-effect  btn-sm waves-light" type="button" >
...
<div class="row mt-2">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="get" action="{{ route('date_wise_search') }}">
                <div class="row">
