...
<div class="row">
    <div class="col-sm-6">
        <div class="float-right d-md-block">
            <div class="dropdown">
            @if (Auth::guard('admin')->user()->can('news_add'))


                <a href="{{ route('admin.news.createe') }}"target="_blank" class="btn btn-success dropdown-toggle waves-effect  btn-sm waves-light" type="button" >
        ...
        <button class="btn btn-danger" type="button" onclick="deleteTag({{ $cat->id }})" data-toggle="tooltip" data-placement="top" title="Delete">
            ...
            <form id="delete-form-{{ $cat->id }}" action="{{ route('admin.news.delete',$cat->id) }}" method="POST" style="display: none;">
                ...
                @csrf
                                          ...
                                          <a href="{{ route('p_newse',$cat->id) }}" class="btn btn-info">
                                                    <i class="fas fa-list"></i>
                                                </a>
                                                
                                                <a href="{{ route('admin.news.edite',$cat->id) }}" class="btn btn-secondary">
