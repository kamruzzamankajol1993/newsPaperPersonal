...
<div class="row">
    <div class="col-md-12">
      ...
      <h4 class="text-center text-primary">Update News</h4>
        ...
        <div class="card-body">
          <form method="post" action="{{route('admin.division_news.update')}}" enctype="multipart/form-data">
            @csrf
<div class="form-row">
...
<div class="form-group col-12 mt-2">
    ...
    <select class="selectpicker form-control"  name="category_id" id="category_id">
      ...
      <option value="{{$cat->id}}" {{ $cat->id == $post->category_id ? 'selected':'' }}>{{$cat->div_name}}</option>
      @endforeach
   ...
   <div class="form-group col-12 mt-2">
    ...
    <select class=" form-control"  id="subcategory_id"  name="subcategory_id">
        ...
        @foreach($categories as $cat)
        <option value="{{$cat->dis_name}}" {{ $cat->dis_name == $post->subcategory_id ? 'selected':'' }}>{{$cat->dis_name}}</option>
        @endforeach
