...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Division News List</h4>
...
<div class="row">
    <div class="col-sm-6">
        <div class="float-right d-md-block">
            <div class="dropdown">
            @if (Auth::guard('admin')->user()->can('div_news_add'))


                <a href="{{ route('admin.division_news.create') }}" class="btn btn-success dropdown-toggle waves-effect  btn-sm waves-light" type="button" >
...
<td>{{$cat->created_at}}</td>
      ...
      <td>
        @if (Auth::guard('admin')->user()->can('div_news_view'))
        <a href="{{route('admin.division_news.detail',$cat->id)}}" class="btn btn-success"><i class="fa fa-eye"></i></a>
        @endif

        @if (Auth::guard('admin')->user()->can('div_news_delete'))
        <button class="btn btn-danger" type="button" onclick="deleteTag({{ $cat->id }})" data-toggle="tooltip" data-placement="top" title="Delete">
            ...
            <form id="delete-form-{{ $cat->id }}" action="{{ route('admin.division_news.delete',$cat->id) }}" method="POST" style="display: none;">
                @method('DELETE')
                @csrf
                ...
                @if (Auth::guard('admin')->user()->can('div_news_edit'))
                                          <a href="{{ route('admin.division_news.edit',$cat->id) }}" class="btn btn-info">
