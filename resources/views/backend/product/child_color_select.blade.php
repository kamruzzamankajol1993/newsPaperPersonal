            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="checkbox" id="cdatabase_image{{ $main_data_id+1 }}" name="cdatabase_image[]" value="{{ $all_image_list->filename }}"/>
                    </div>
                    @endforeach
                </div>
                <div class="mt-5">
...
$(".closeec").click(function(){
    $("#cmyModal").modal('hide');
        ...
        $("[id^=cdatabase_image_upload_result]").click(function(){
            var main_data_id1 = $(this).attr('data-dnumber');
var cdatabase_image_upload = $('input[name^="cdatabase_image[]"]:checked').map(function (idx, ele) {
return $(ele).val();
}).get();
