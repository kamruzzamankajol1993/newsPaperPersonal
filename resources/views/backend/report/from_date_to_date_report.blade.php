...
<div class="row mt-2">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <label for="exampleFormControlInput1">User List</label>
    ...
    <input type="date" class="form-control" value="{{$form_date}}" name="form_date" id="exampleFormControlInput1" placeholder="">
  </div>
                    </div>
    ...
    <input type="date" class="form-control" value="{{$to_date}}" name="to_date" id="exampleFormControlInput1" placeholder="">
  </div>
                    </div>
