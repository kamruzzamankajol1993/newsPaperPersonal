...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Logo Information</h4>
    ...
    <div class="col-12">
        <h4 class="card-title"> Logo Listing</h4>
        <p class="card-title-desc">You can <code>Show, Hide & Edit</code> all Logos</p>
    </div>
</div>
...
<div class="row mt-2">
    ...
    <div class="col-sm-6">
        <div class="text-sm-end">
            <button type="button"
                ...
                <i class="mdi mdi-plus me-1"></i> Add New Logo
            </button>
        </div>
            <!-- Modal -->
    ...
    <h5 class="modal-title" id="exampleModalLabel">Add Logo Information</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
    </button>
    </div>
    <div class="modal-body">
        <form class="mt-3" method="Post" action="{{ route('admin.unit.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="name">
                            ...
                            <option value="Bangla Site Header Logo">Bangla Site Header Logo</option>
                            <option value="Bangla Site Footer Logo">Bangla Site Footer Logo</option>
                            <option value="Engish Site Header Logo">Engish Site Header Logo</option>
                             <option value="Engish Site Footer Logo">Engish Site Footer Logo</option>
                              <option value="Bangla Language Banner">Bangla Language Banner</option>
                               <option value="English Language Banner">English Language Banner</option>
                               <option value="personal_logo">Personal Logo</option>
                        </select>
                    </div>
                </div>
