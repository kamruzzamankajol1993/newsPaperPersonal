...
<div class="row">
        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Product All Brand</li>
                </ol>
            </div>
    ...
    <div class="col-12">
        <h4 class="card-title">Product Brand Listing</h4>
        <p class="card-title-desc">You can <code>Show, Hide & Edit</code> all Brands</p>
    </div>
</div>
<!-- search bar --->
<div class="row">
...
<div class="row mt-2">
    ...
    <div class="modal-body">
        <form class="mt-3" method="Post" action="{{ route('admin.brand.store') }}">
            @csrf
            <div class="row">
                ...
                <div class="table-responsive">
                    <table class="table  table-striped">
                        ...
                        <tbody>
                            ...
                            @foreach($brand_list as $key=>$all_attribute)
                        <tr>
                            <td>
                                <div class="form-check font-size-16">
