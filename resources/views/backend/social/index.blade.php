...
<div class="table-responsive">
    ...
    style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <th>Action</th>
                                        ...
                                        <tbody>
                                            @foreach ($attribute_list as $user)
...
<div class="row">
 ...
 <div class="form-group col-md-12 col-sm-12">
    <label for="password">Social Media Name </label>
<select class="form-control form-control-sm"  name="linkn" placeholder="Enter Name">
    <option value="12">--Please Select --</option>
    <option value="Linkedin" {{ $user->linkn == 'Linkedin' ? 'Selected':''}}>Linkedin</option>
    <option value="Facebook" {{ $user->linkn == 'Facebook' ? 'Selected':''}}>Facebook</option>
    <option value="Youtube" {{ $user->linkn == 'Youtube' ? 'Selected':''}}>Youtube</option>
    <option value="Twitter" {{ $user->linkn == 'Twitter' ? 'Selected':''}}>Twitter</option>
    <option value="Linkedin" {{ $user->linkn == 'Instagram' ? 'Selected':''}}>Instagram</option>
</select>
