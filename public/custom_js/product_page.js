$(document).ready(function () {
    ...
    $("[id^=category_name]").click(function(){
        ...
        $.ajax({
            url: "from_category_to_subcategory",
            method: 'GET',
...
//alert(main_category_name);
        $.ajax({
            url: "slection_list_from_cat_to_eight_child",
            method: 'GET',
    ...
    $("[id^=subcategory_name]").click(function(){
        ...
        $.ajax({
            url: "from_subcategory_to_first_child",
            method: 'GET',
...
//end slection list
    ...
    $("[id^=childone_name]").click(function(){
        ...
        $.ajax({
            url: "from_first_child_to_second_child",
            method: 'GET',
...
//end slection list
    $("[id^=childtwo_name]").click(function(){
        ...
        $.ajax({
            url: "from_second_child_to_third_child",
            method: 'GET',
...
//end slection list
    $("[id^=childthree_name]").click(function(){
        ...
        $.ajax({
            url: "from_third_child_to_fourth_child",
            method: 'GET',
...
//end slection list
    $("[id^=childfour_name]").click(function(){
        ...
        $.ajax({
            url: "from_fourth_child_to_fifth_child",
            method: 'GET',
...
//end slection list
    $("[id^=childfive_name]").click(function(){
        ...
        $.ajax({
            url: "from_fifth_child_to_sixth_child",
            method: 'GET',
...
//end slection list
    $("[id^=childsix_name]").click(function(){
        ...
        $.ajax({
            url: "from_sixth_child_to_seven_child",
            method: 'GET',
...
//end slection list
    $("[id^=childseven_name]").click(function(){
        ...
        $.ajax({
            url: "from_seven_child_to_eight_child",
            method: 'GET',
    ...
    $('#add_product_category_search').on('keyup', function () {
        ...
        $.ajax({
            url: "add_product_category_search",
            method: 'GET',
    ...
    $('#add_product_subcategory_search').on('keyup', function () {
        ...
        $.ajax({
            url: "add_product_subcategory_search",
            method: 'GET',
            data: {search_value:search_value,data_type:data_type},
            success: function(data) {
    ...
    $('#add_product_childone_search').on('keyup', function () {
        ...
        $.ajax({
            url: "add_product_childone_search",
            method: 'GET',
            data: {search_value:search_value,data_type:data_type},
            success: function(data) {
    ...
    $('#add_product_childtwo_search').on('keyup', function () {
        ...
        $.ajax({
            url: "add_product_childtwo_search",
            method: 'GET',
            data: {search_value:search_value,data_type:data_type},
            success: function(data) {
    ...
    $('#add_product_childthree_search').on('keyup', function () {
        ...
        $.ajax({
            url: "add_product_childthree_search",
            method: 'GET',
            data: {search_value:search_value,data_type:data_type},
            success: function(data) {
    ...
    $('#add_product_childfour_search').on('keyup', function () {
        ...
        $.ajax({
            url: "add_product_childfour_search",
            method: 'GET',
            data: {search_value:search_value,data_type:data_type},
            success: function(data) {
    ...
    $('#add_product_childfive_search').on('keyup', function () {
        ...
        $.ajax({
            url: "add_product_childfive_search",
            method: 'GET',
            data: {search_value:search_value,data_type:data_type},
            success: function(data) {
    ...
    $('#add_product_childsix_search').on('keyup', function () {
        ...
        $.ajax({
            url: "add_product_childsix_search",
            method: 'GET',
            data: {search_value:search_value,data_type:data_type},
            success: function(data) {
    ...
    $('#add_product_childseven_search').on('keyup', function () {
        ...
        $.ajax({
            url: "add_product_childseven_search",
            method: 'GET',
            data: {search_value:search_value,data_type:data_type},
            success: function(data) {
