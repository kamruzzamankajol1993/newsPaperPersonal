...
class AttributeDetailController extends Controller
{
    ...
    public function __construct()
    {
     ...
     public function indexs(){
         ...
         $attribute_list = Divisionnewscategory::latest()->get();

        return view('backend.social.index',compact('attribute_list'));
      ...
      public function stores(Request $request){
            ...
            $category_list = new Divisionnewscategory();
            $category_list->name	 = $request->name;
            $category_list->linkn = $request->linkn;
      ...
      public function updates(Request $request){
            ...
            $category_list = Divisionnewscategory::find($request->id);
           $category_list->name	 = $request->name;
            $category_list->linkn = $request->linkn;
            $category_list->save();
    ...
    public function deletes($id)
{
    ...
    $admins = Divisionnewscategory::find($id);
    if (!is_null($admins)) {
        $admins->delete();
    }
